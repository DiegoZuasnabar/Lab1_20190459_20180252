    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener((view)->{
            ...
            if(c2==true && c3==false && c4==false){
                texto ="Su compra de 2 tickets con un valor total de S/30.00 fue realizado con éxito";
            }
            if(c2==false && c3==true && c4==false){
                texto ="Su compra de 2 tickets con un valor total de S/26.00 fue realizado con éxito";
            }
            if(c2==false && c3==false && c4==true){
                texto ="Su compra de 2 tickets con un valor total de S/23.00 fue realizado con éxito";
            }
            ...
            if(c2==true && c3==true && c4==true){
                texto ="Su compra de 2 tickets con un valor total de S/79.00 fue realizado con éxito";
            }
